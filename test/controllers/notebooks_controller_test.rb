...
class NotebooksControllerTest < ActionController::TestCase
  ...
  test "should create notebook" do
    assert_difference('Notebook.count') do
      post :create, notebook: { active: @notebook.active, description: @notebook.description, name: @notebook.name }
    end
  ...
  test "should update notebook" do
    patch :update, id: @notebook, notebook: { active: @notebook.active, description: @notebook.description, name: @notebook.name }
    assert_redirected_to notebook_path(assigns(:notebook))
  end
